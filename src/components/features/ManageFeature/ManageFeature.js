...
export default function ManageFeature() {
    return (
        <section className="w-full px-5 pt-7 pb-20 md:px-6 lg:px-7">
            ...
            <div className="mx-auto mt-10 flex w-full max-w-7xl items-center justify-center gap-3">
                <button className="cursor-pointer rounded-lg border border-slate-900 p-2 text-slate-500 transition-colors duration-200 ease-linear hover:text-slate-400">
                    <MdKeyboardDoubleArrowLeft />
                </button>
                <div className="flex size-[34px] items-center justify-center rounded-lg bg-violet-600">
